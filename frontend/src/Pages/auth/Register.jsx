...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const res = await registerUser({ name, email, password }); // Using API function
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-gray-100 py-7">
      <div className="bg-white shadow-md rounded-2xl p-8 w-full gap-8 max-w-4xl mx-4 flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 w-full flex flex-col justify-center">
          <h2 className="text-3xl text-[#552501] font-bold text-center mb-6" style={{ fontFamily: "Kugile" }}>Create Account</h2>
          <p className="text-center text-gray-500 mb-6">Sign up to start shopping the latest dresses.</p>
